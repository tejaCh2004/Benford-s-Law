...
public class Benford {
    ...
    public static void fileReader() throws java.nio.file.InvalidPathException {
        ...
        String newLine = "";
        System.out.println(
                "Enter the entire file path of the file you would like to read. Including the file name (sales.csv)!");
    ...
    public static void frequencyCalculation(String[] salesArray) {
        ...
        if (frequency1 >= 29 && frequency1 <= 32) {
            System.out.println(
                    "Since frequency of 1 being in the first digit is between 29% to 32 %, fraud likely did not occur.");
    ...
    public static double[] initialCount() {
        double[] count = new double[10];
